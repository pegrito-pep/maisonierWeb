<template>
    <div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="widget">
                    <div class="widget-body">
                        ...
                        <small class="fa-lg text-muted mt-10 d-block">{{ nbrLocataireActif }} actifs</small>
                    </div>
                    <div class="progress">
                        <div class="progress-bar" :class="{'bg-success': tauxLocataireActif >= 80, 'bg-warning': (tauxLocataireActif >= 30 && tauxLocataireActif < 80), 'bg-danger': tauxLocataireActif < 30 }" role="progressbar" :aria-valuenow="tauxLocataireActif" aria-valuemin="0" aria-valuemax="100" :style="'width: ' + tauxLocataireActif + '%;'">{{ tauxLocataireActif }}% actif</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <b-row class="mt-3">
            <b-col lg="6" sm="12">
                <div class="card">
                    <div class="card-header"><h3>Recouvrements du mois</h3></div>
                    <div class="card-body">
            ...
            <b-col lg="3" sm="12">
                <div class="card">
                    <div class="card-header"><h3>Logements</h3></div>
                    <div class="card-body">
             ...
             <b-col lg="3" sm="12">
                <div class="card">
                    <div class="card-header"><h3>Locataires</h3></div>
                    <div class="card-body">
            ...
            <b-col cols="12">
                <div class="card">
                    <div class="card-header"><h3>Recouvrements annuel</h3></div>
                    <div class="card-body">
            ...
            <b-col cols="12">
                <div class="card">
                    <div class="card-header"><h3>Logements par batiment</h3></div>
                    <div class="card-body">
