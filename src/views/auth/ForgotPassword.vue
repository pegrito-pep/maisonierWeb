                ...
                <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                    <div class="authentication-form mx-auto">
                        <div class="mt-n5 mb-4 d-flex justify-content-center align-items-center flex-column">
                            ...
                            <h3 class="text-center mt-2 mb-0 font-weight-bold">Retrouver votre mot de passe</h3>
                        </div>
                        ...
                        <div class="register">
                            <p>Pas de compte? <b-link :to="{name: 'register'}" class="forgotpwd">Créer un compte maintenant</b-link></p>
                        </div>
                    </div>
                </div>
            </b-row>
